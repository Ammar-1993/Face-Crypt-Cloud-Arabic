...
* **🔑 دعم مفاتيح المرور (WebAuthn/Passkeys):** طبقة مصادقة إضافية تعتمد على الأجهزة. يتم تسجيل مفتاح المرور بشكل اختياري كطريقة بديلة وسريعة لتسجيل الدخول مستقبلاً، ولا يمكن تسجيله إلا بعد اجتياز التحقق الأمني الأساسي بالوجه بنجاح (لا يعتبر بديلاً تاماً للتسجيل الأولي بالوجه بل مكملاً له).
